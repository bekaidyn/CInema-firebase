        ...
        <section >
            {bgImage && (
                <div>
                    ...
                    <div className='backdrop-brightness-[90%] w-full pl-[10%] px-[15%] pb-20 lg:top-[60%] lg1:absolute lg1:top-[30%] lg1:pl-[10%] lg1:text-white lg1:text-left sm:text-center sm:relative sm:text-gray-800 sm:p-0 sm:text-xs'>
                        <div className="sm:m-2 font-extralight">SUNDAYS AT 9 PM</div>
                        <h1 className='text-5xl sm:my-3'><strong>{bgImage.title}</strong></h1>
                        <p className="sm:text-base sm:m-4 font-extralight">{bgImage.plot}</p>
